...
class IBLink
{
    public static function GetUserTypeDescription()
    {
        return [
            ...
            'DESCRIPTION' => 'Ссылка для href', //название тип пользовательского поля
            ...
            'GetAdminListViewHTML' => [self::class, 'GetAdminListViewHTML'], //метод отображения значения в списке элементов в Админке
    ...
    public static function GetPublicViewHTML($arProperty, $arValue, $strHTMLControlName)
    {
        ...
        if(!is_array($arProperty['VALUE'])){
            ...
            $arProperty['DESCRIPTION'] = [$arProperty['DESCRIPTION']];
        }
